...
<body>
    ...
    <nav class="col-md-3 col-lg-2 sidebar" id="sidebar">
        ...
        <a href="{{ route('supervisor.activity-log') }}" class="{{ request()->routeIs('supervisor.activity-log') ? 'active' : '' }}">
            <i class="fas fa-chart-line mr-2"></i>{{ __('site.supervisor.activity_log.title') }}</a>
        <div class="mt-auto" style="position: absolute; bottom: 20px; width: 100%;">
            <div class="dropdown">
                ...
                <div class="submenu" id="superadminSubmenu">
                    <a href="{{ route('supervisor.profile') }}" class="submenu-item"><i class="fas fa-user-circle mr-2"></i>{{ __('site.sidebar.profile') }}</a>
